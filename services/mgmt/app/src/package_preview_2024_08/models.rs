...
use azure_core::date::parse_rfc3339_option;
...
pub struct SystemData {
    ...
    #[serde(rename = "createdAt", deserialize_with = "parse_rfc3339_option", default)]
    pub created_at: Option<::time::OffsetDateTime>,
    ...
    #[serde(rename = "lastModifiedAt", deserialize_with = "parse_rfc3339_option", default)]
    pub last_modified_at: Option<::time::OffsetDateTime>,
}
impl SystemData {
    pub fn new() -> Self {
