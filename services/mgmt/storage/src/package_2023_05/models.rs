...
#[doc = "Target helps provide filter parameters for the objects in the storage account and forms the execution context for the storage task"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExecutionTarget {
    #[doc = "Required list of object prefixes to be included for task execution"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "List of object prefixes to be excluded from task execution. If there is a conflict between include and exclude prefixes, the exclude prefix will be the determining factor"]
    #[serde(
        rename = "excludePrefix",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "Execution trigger for storage task assignment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExecutionTrigger {
    #[doc = "The trigger type of the storage task assignment execution"]
    #[serde(rename = "type")]
    pub type_: execution_trigger::Type,
    #[doc = "The trigger parameters update for the storage task assignment execution"]
    pub parameters: TriggerParameters,
}
impl ExecutionTrigger {
    pub fn new(type_: execution_trigger::Type, parameters: TriggerParameters) -> Self {
        Self { type_, parameters }
    }
}
...
#[doc = "Execution trigger update for storage task assignment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExecutionTriggerUpdate {
    #[doc = "The trigger type of the storage task assignment execution"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<execution_trigger_update::Type>,
    #[doc = "The trigger parameters update for the storage task assignment execution"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<TriggerParametersUpdate>,
}
impl ExecutionTriggerUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod execution_trigger_update {
    use super::*;
    #[doc = "The trigger type of the storage task assignment execution"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct LocalUserProperties {
    ...
    #[doc = "A unique Identifier that is generated by the server."]
    #[serde(rename = "userId", default, skip_serializing_if = "Option::is_none")]
    pub user_id: Option<i32>,
    #[doc = "An identifier for associating a group of users."]
    #[serde(rename = "groupId", default, skip_serializing_if = "Option::is_none")]
    pub group_id: Option<i32>,
    #[doc = "Indicates whether ACL authorization is allowed for this user. Set it to false to disallow using ACL authorization."]
    #[serde(rename = "allowAclAuthorization", default, skip_serializing_if = "Option::is_none")]
    pub allow_acl_authorization: Option<bool>,
    #[doc = "Supplementary group membership. Only applicable for local users enabled for NFSv3 access."]
    #[serde(
    ...
    pub extended_groups: Vec<i32>,
    #[doc = "Indicates if the local user is enabled for access with NFSv3 protocol."]
    #[serde(rename = "isNFSv3Enabled", default, skip_serializing_if = "Option::is_none")]
    pub is_nf_sv3_enabled: Option<bool>,
}
...
#[doc = "List of local users requested, and if paging is required, a URL to the next page of local users."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LocalUsers {
    #[doc = "The list of local users associated with the storage account."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "Request URL that can be used to query next page of local users. Returned when total number of requested local users exceeds the maximum page size."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "The Network Security Perimeter configuration resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Result of the List Network Security Perimeter configuration operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationList {
    #[doc = "A collection of Network Security Perimeter configurations"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub mod network_security_perimeter_configuration_properties {
    ...
    pub mod resource_association {
        ...
        impl Serialize for AccessMode {
            ...
            {
                match self {
                    Self::Enforced => serializer.serialize_unit_variant("AccessMode", 0u32, "Enforced"),
                    Self::Learning => serializer.serialize_unit_variant("AccessMode", 1u32, "Learning"),
    ...
    pub struct Profile {
        ...
        pub access_rules_version: Option<f64>,
        ...
        #[doc = "Diagnostic settings version"]
        #[serde(rename = "diagnosticSettingsVersion", default, skip_serializing_if = "Option::is_none")]
        pub diagnostic_settings_version: Option<f64>,
        #[doc = "Enabled logging categories"]
        #[serde(
...
#[doc = "Information of Access Rule in Network Security Perimeter profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct PermissionScope {
    #[doc = "The permissions for the local user. Possible values include: Read (r), Write (w), Delete (d), List (l), Create (c), Modify Ownership (o), and Modify Permissions (p)."]
...
pub mod provisioning_issue {
    ...
    pub struct Properties {
        ...
        pub issue_type: Option<properties::IssueType>,
        #[doc = "Severity of the issue."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub severity: Option<properties::Severity>,
    ...
    pub mod properties {
        ...
        impl Serialize for IssueType {
            ...
            {
                match self {
                    Self::Unknown => serializer.serialize_unit_variant("IssueType", 0u32, "Unknown"),
                    Self::ConfigurationPropagationFailure => {
                        serializer.serialize_unit_variant("IssueType", 1u32, "ConfigurationPropagationFailure")
                    }
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
...
#[doc = "Allow, disallow, or let Network Security Perimeter configuration to evaluate public network access to Storage Account. Value is optional but if passed in, must be 'Enabled', 'Disabled' or 'SecuredByPerimeter'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct SasPolicy {
    ...
    #[doc = "The SAS Expiration Action defines the action to be performed when sasPolicy.sasExpirationPeriod is violated. The 'Log' action can be used for audit purposes and the 'Block' action can be used to block and deny the usage of SAS tokens that do not adhere to the sas policy expiration period."]
    ...
    impl Serialize for ExpirationAction {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Block => serializer.serialize_unit_variant("ExpirationAction", 1u32, "Block"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct StorageAccountProperties {
    ...
    #[doc = "Enables extended group support with local users feature, if set to true"]
    #[serde(rename = "enableExtendedGroups", default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for MinimumTlsVersion {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Tls13 => serializer.serialize_unit_variant("MinimumTlsVersion", 3u32, "TLS1_3"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The storage task assignment."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StorageTaskAssignment {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Properties of the storage task assignment."]
    pub properties: StorageTaskAssignmentProperties,
}
impl StorageTaskAssignment {
    pub fn new(properties: StorageTaskAssignmentProperties) -> Self {
        Self {
...
#[doc = "Execution context of the storage task assignment."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StorageTaskAssignmentExecutionContext {
    #[doc = "Target helps provide filter parameters for the objects in the storage account and forms the execution context for the storage task"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl StorageTaskAssignmentExecutionContext {
    pub fn new(trigger: ExecutionTrigger) -> Self {
        Self { target: None, trigger }
    }
}
#[doc = "Properties of the storage task assignment."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StorageTaskAssignmentProperties {
    #[doc = "Id of the corresponding storage task"]
    #[serde(rename = "taskId")]
    pub task_id: String,
    #[doc = "Whether the storage task assignment is enabled or not"]
    pub enabled: bool,
    #[doc = "Text that describes the purpose of the storage task assignment"]
    pub description: String,
    #[doc = "Execution context of the storage task assignment."]
    #[serde(rename = "executionContext")]
    pub execution_context: StorageTaskAssignmentExecutionContext,
    #[doc = "The storage task assignment report"]
    pub report: StorageTaskAssignmentReport,
    #[doc = "Represents the provisioning state of the storage task assignment."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<storage_task_assignment_properties::ProvisioningState>,
    #[doc = "Storage task execution report for a run instance."]
    #[serde(rename = "runStatus", default, skip_serializing_if = "Option::is_none")]
    pub run_status: Option<StorageTaskReportProperties>,
}
impl StorageTaskAssignmentProperties {
    pub fn new(
        task_id: String,
        enabled: bool,
        description: String,
...
pub mod storage_task_assignment_properties {
    use super::*;
    #[doc = "Represents the provisioning state of the storage task assignment."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum ProvisioningState {
...
#[doc = "The storage task assignment report"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StorageTaskAssignmentReport {
    #[doc = "The container prefix for the location of storage task assignment report"]
    pub prefix: String,
}
impl StorageTaskAssignmentReport {
    pub fn new(prefix: String) -> Self {
        Self { prefix }
    }
}
#[doc = "Execution context of the storage task assignment update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTaskAssignmentUpdateExecutionContext {
    #[doc = "Target helps provide filter parameters for the objects in the storage account and forms the execution context for the storage task"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ExecutionTarget>,
    #[doc = "Execution trigger update for storage task assignment"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub trigger: Option<ExecutionTriggerUpdate>,
}
impl StorageTaskAssignmentUpdateExecutionContext {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters of the storage task assignment update request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTaskAssignmentUpdateParameters {
    #[doc = "Properties of the storage task update assignment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<StorageTaskAssignmentUpdateProperties>,
}
impl StorageTaskAssignmentUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of the storage task update assignment."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTaskAssignmentUpdateProperties {
    #[doc = "Id of the corresponding storage task"]
    ...
    pub description: Option<String>,
    #[doc = "Execution context of the storage task assignment update."]
    #[serde(rename = "executionContext", default, skip_serializing_if = "Option::is_none")]
    pub execution_context: Option<StorageTaskAssignmentUpdateExecutionContext>,
    #[doc = "The storage task assignment report"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub report: Option<StorageTaskAssignmentUpdateReport>,
    #[doc = "Represents the provisioning state of the storage task assignment."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<storage_task_assignment_update_properties::ProvisioningState>,
    #[doc = "Storage task execution report for a run instance."]
    #[serde(rename = "runStatus", default, skip_serializing_if = "Option::is_none")]
    pub run_status: Option<StorageTaskReportProperties>,
}
impl StorageTaskAssignmentUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod storage_task_assignment_update_properties {
    use super::*;
    #[doc = "Represents the provisioning state of the storage task assignment."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum ProvisioningState {
...
#[doc = "The storage task assignment report"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTaskAssignmentUpdateReport {
    #[doc = "The prefix of the storage task assignment report"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prefix: Option<String>,
}
impl StorageTaskAssignmentUpdateReport {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of storage task assignments for the storage account"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTaskAssignmentsList {
    #[doc = "Gets the list of storage task assignments and their properties."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "Request URL that can be used to query next page of storage task assignments. Returned when total number of requested storage task assignments exceed maximum page size."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for StorageTaskAssignmentsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl StorageTaskAssignmentsList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct TriggerParameters {
    #[doc = "When to start task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "startFrom", default, with = "azure_core::date::rfc3339::option")]
    pub start_from: Option<::time::OffsetDateTime>,
    #[doc = "Run interval of task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<i32>,
    #[doc = "Run interval unit of task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "intervalUnit", default, skip_serializing_if = "Option::is_none")]
    pub interval_unit: Option<trigger_parameters::IntervalUnit>,
    #[doc = "When to end task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "endBy", default, with = "azure_core::date::rfc3339::option")]
    pub end_by: Option<::time::OffsetDateTime>,
    #[doc = "When to start task execution. This is an optional field when ExecutionTrigger.properties.type is 'RunOnce'; this property should not be present when ExecutionTrigger.properties.type is 'OnSchedule'"]
    #[serde(rename = "startOn", default, with = "azure_core::date::rfc3339::option")]
    pub start_on: Option<::time::OffsetDateTime>,
}
...
#[doc = "The trigger parameters update for the storage task assignment execution"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TriggerParametersUpdate {
    #[doc = "When to start task execution. This is a mutable field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "startFrom", default, with = "azure_core::date::rfc3339::option")]
    pub start_from: Option<::time::OffsetDateTime>,
    #[doc = "Run interval of task execution. This is a mutable field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<i32>,
    #[doc = "Run interval unit of task execution. This is a mutable field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "intervalUnit", default, skip_serializing_if = "Option::is_none")]
    pub interval_unit: Option<trigger_parameters_update::IntervalUnit>,
    #[doc = "When to end task execution. This is a mutable field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[serde(rename = "endBy", default, with = "azure_core::date::rfc3339::option")]
    pub end_by: Option<::time::OffsetDateTime>,
    #[doc = "When to start task execution. This is a mutable field when ExecutionTrigger.properties.type is 'RunOnce'; this property should not be present when ExecutionTrigger.properties.type is 'OnSchedule'"]
    #[serde(rename = "startOn", default, with = "azure_core::date::rfc3339::option")]
    pub start_on: Option<::time::OffsetDateTime>,
}
impl TriggerParametersUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod trigger_parameters_update {
    use super::*;
    #[doc = "Run interval unit of task execution. This is a mutable field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum IntervalUnit {
